        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} hoverEffect={event.title !== 'Codesphere'} className="p-0 overflow-hidden group flex flex-col h-full rounded-2xl border-white/10">
                {event.title === 'Codesphere' ? (
                  <div className="relative w-full bg-black/50 border-b border-white/10">
                    <div className="h-[400px] w-full overflow-hidden">
                      <ThreeDCarousel />
                    </div>
                    <div className="py-3 text-center bg-white/[0.03] border-t border-white/5">
                      <a
                        href="https://drive.google.com/drive/folders/1EKrQTt_bXAoZ5ffZY_h9pIUQufG5gIOY?usp=drive_link"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-xs font-medium text-primary hover:text-primary/80 transition-colors uppercase tracking-widest"
                      >
