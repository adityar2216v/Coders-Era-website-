...
export default function GalleryPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            {/* Synapse & Syntax Section - 4th Event */}
            <Section className="py-24">
                <Container>
                    <motion.div
                        initial={{ opacity: 0, x: 50 }}
                    ...
                    >
                        <div>
                            <span className="text-[#FB7185] text-sm font-bold tracking-wider uppercase block mb-1">4th Event</span>
                            <h2 className="text-3xl md:text-5xl font-bold text-white">Synapse & <span className="text-[#FB7185]">Syntax</span></h2>
                        </div>
                        <div className="h-12 w-1 bg-[#FB7185] rounded-full" />
                    </motion.div>

                    <ThreeDCarousel
                        images={[
                            '/photos/Synapse & Syntax.jpg',
                            '/synapse and syntax/IMG_3155.JPG.jpeg',
                            '/synapse and syntax/IMG_3159.JPG.jpeg',
                            '/synapse and syntax/IMG_3163.JPG.jpeg',
                            '/synapse and syntax/IMG_3178.JPG.jpeg',
                            '/synapse and syntax/IMG_3179.JPG.jpeg',
                            '/synapse and syntax/WhatsApp Image 2026-02-07 at 4.54.38 PM.jpeg',
                            '/synapse and syntax/WhatsApp Image 2026-02-07 at 4.54.43 PM.jpeg',
                            '/synapse and syntax/WhatsApp Image 2026-02-07 at 4.54.44 PM.jpeg',
                        ]}
                        height="500px"
                        autoScrollInterval={2000}
                    />
